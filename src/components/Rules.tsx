    ...
    <li>
      ...
      <Section title="Keeper">
        <ul className="list-disc ml-6">
          ...
          <li>
          De keeper mag de bal maar 1 keer met de handen vastpakken. De bal moet eerst een andere speler hebben geraakt voor hij/zij de bal weer met de handen mag pakken.</li>
        </ul>
      </Section>
