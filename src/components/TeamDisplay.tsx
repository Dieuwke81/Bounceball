  ...
  <div className="flex items-center bg-gray-600/50 p-2 rounded hover:bg-gray-600 transition-colors">
    ...
    <div className="flex justify-between items-center w-[4.5rem]">
      ...
      <ScoreInput
        ...
        className="w-6 h-6 bg-gray-700 border border-red-500/70 rounded-md p-0.5 text-white text-center focus:outline-none focus:ring-1 focus:ring-red-500 text-[11px]"
      />
    </div>
  </div>
);
