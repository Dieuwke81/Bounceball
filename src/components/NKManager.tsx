  ...
  return (
    <div className="space-y-6 pb-20 text-white font-black font-black font-black font-black">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 no-print text-white font-black font-black font-black">
          <div className="bg-gray-800 border-2 border-amber-500 rounded-3xl p-8 max-w-sm w-full space-y-6 shadow-2xl text-white font-black font-black font-black font-black">
            ...
            <div className="space-y-3 font-black font-black font-black">
              ...
              <button onClick={() => handlePrintAction('standings')} className="w-full py-4 bg-gray-700 hover:bg-amber-500 text-white font-bold rounded-2xl transition-all uppercase text-xs font-black font-black font-black">Stand</button>
            </div>
      ...
      <div className="no-print space-y-8 text-white font-black">
        {activeTab === 'schedule' && (
          <>
            <input type="text" placeholder="Naam markeren..." value={highlightName} onChange={e => setHighlightName(e.target.value)} className="w-full bg-gray-800 p-4 rounded-2xl text-white border border-gray-700 outline-none focus:ring-2 ring-green-500 transition-all font-black uppercase font-black" />
              ...
              <div key={rIdx} className="space-y-4 text-white font-black">
                ...
                <div className="grid lg:grid-cols-2 gap-6 text-white font-black">
                  {round.matches.map((match, mIdx) => {
                    ...
                    return (
                      <div key={match.id} className={`match-card bg-gray-800 rounded-2xl border-2 ${match.isPlayed ? 'border-green-500/50 shadow-lg shadow-green-500/5 font-black' : 'border-gray-700'} overflow-hidden text-white font-black`}>
                        <div className="bg-gray-900/50 p-3 flex justify-between text-[10px] font-black uppercase text-gray-500 tracking-widest text-white font-black">
                          <span>📍 ZAAL <span className="text-red-500 text-sm ml-1 font-black uppercase text-white font-black font-black">{match.hallName}</span></span>
                          {isFixed ? (
                        ...
                        <div className="p-5 flex justify-between items-stretch gap-4 text-white font-black">
                          ...
                          <div className="flex-1 space-y-1 text-right text-white font-black">
                            <div className="text-[9px] text-amber-400 font-black uppercase mb-2 tracking-widest text-white font-black font-black font-black">{(match as any).team2Name || 'Team Geel'}</div>
                            {match.team2.map(p => {
                                const rColor = ratingColors.get(p.rating);
