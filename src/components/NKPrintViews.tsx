    ...
    <div className="print-only">
      <style>{`
        @media print {
          ...
          .color-geel { color: #ffcc00 !important; } 
      ...
      {activePrintType === 'overview' && session.rounds.map((round) => (
        <div key={round.roundNumber} className="page-break">
          <div className="p-4">
            {/* Ronde nummer bovenaan de pagina */}
